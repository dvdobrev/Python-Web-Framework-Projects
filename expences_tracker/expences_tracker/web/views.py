...
from expences_tracker.web.forms import CreateProfileForm, EditProfileForm, DeleteProfileForm, CreateExpenseForm, \
    EditExpenseForm, DeleteExpenseForm
from expences_tracker.web.models import Profile, Expense
